...
filename = strcat(path, 'ude_observer_cncm', '_kcn=', num2str(kcn), '_kcm=', num2str(kcm), '_X1_.csv');
csvwrite(filename, x1);

filename = strcat(path, 'ude_observer_cncm', '_kcn=', num2str(kcn), '_kcm=', num2str(kcm), '_CONTROL_.csv');
csvwrite(filename, control);

filename = strcat(path, 'ude_observer_cncm', '_kcn=', num2str(kcn), '_kcm=', num2str(kcm), '_PITCH_.csv');
