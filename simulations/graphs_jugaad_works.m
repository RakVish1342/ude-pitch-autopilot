...
% %%% ======================== fusion-jugaad--one-line-commented-at-a-time ======================
% 
% figure;
% set(gcf,'DefaultLineLineWidth',1.5)
% set(gca,'FontSize',18,'FontWeight','bold')
% hold on;
% plot(t,control*r2d,'k-');
% grid;
% xlabel('Time (s)', 'fontsize', 18);
% ylabel('Pitch Rate (deg/s)', 'fontsize', 18);
% % legend('pitch-pc', 'pitch-smc', 'pitch-ude');
...
% %%% ======================== ude_observer_varying-mach_jugaad ======================
% 
% figure;
% set(gcf,'DefaultLineLineWidth',1.5)
% set(gca,'FontSize',18,'FontWeight','bold')
...
% set(gca,'FontSize',18,'FontWeight','bold')
% hold on;
% plot(t,x1*r2d,'k-', t,x1cap*r2d,'b--', t,xref*r2d,'r:');
% grid;
% xlabel('Time (s)', 'fontsize', 18);
% ylabel('Angle of Attack (deg)', 'fontsize', 18);
% legend('x1-actual', 'x1-cap', 'xref');
...
% set(gca,'FontSize',18,'FontWeight','bold')
% hold on;
% plot(t,dist*r2d,'r:',t,dcap*r2d,'k-');
% grid;
% xlabel('Time (s)', 'fontsize', 18);
...
% grid;
% xlabel('Time (s)', 'fontsize', 18);
% ylabel('Mach Number', 'fontsize', 18);
% 
% % figure;
% % set(gcf,'DefaultLineLineWidth',1.5)
% % set(0,'DefaultAxesFontName', 'Times', 'DefaultTextFontName', 'Times')
